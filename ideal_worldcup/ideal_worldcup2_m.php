  ...
  <div class="wrap">
    ...
    <section id="lovetest">
      <div class="join-charge">
        ...
        <div style="height:550px;">
          <img class="image_size" onclick="show(2,'../../static/images/lovetest/ideal_worldcup/9.jpg','슈트핏이 좋은 남자');" src="../../static/images/lovetest/ideal_worldcup/9.jpg">
          <img class="image_size" onclick="show(2,'../../static/images/lovetest/ideal_worldcup/10.jpg','캐쥬얼이 잘 어울리는 남자');" src="../../static/images/lovetest/ideal_worldcup/10.jpg">
        </div>
    ...
    <section id="lovetest">
      <div class="join-charge">
        ...
        <!-- 이상형월드컵 이미지 및 텍스트 배치 -->
        <div style="height:550px;">
          <img class="image_size" onclick="show(3,'../../static/images/lovetest/ideal_worldcup/11.jpg','유머코드가 잘 맞는 남자');" src="../../static/images/lovetest/ideal_worldcup/11.jpg">
          <img class="image_size" onclick="show(3,'../../static/images/lovetest/ideal_worldcup/12.jpg','배울 점이 많은 남자');" src="../../static/images/lovetest/ideal_worldcup/12.jpg">
        </div>
        <div class="ideal_text1">
    ...
    <section id="lovetest">
      <div class="join-charge">
        ...
        <!-- 이상형월드컵 이미지 및 텍스트 배치 -->
        <div style="height:550px;">
          <img class="image_size" onclick="show(4,'../../static/images/lovetest/ideal_worldcup/13.jpg','운동 잘하는 남자');" src="../../static/images/lovetest/ideal_worldcup/13.jpg">
          <img class="image_size" onclick="show(4,'../../static/images/lovetest/ideal_worldcup/14.jpg','요리 잘하는 남자');" src="../../static/images/lovetest/ideal_worldcup/14.jpg">
        </div>
        <div class="ideal_text1">
