...
<head>
  ...
  <script>
    ...
    function show(idx, src, result) { //onclick event 처리 함수 및 데이터 처리
      ...
      if (ideal_result == "슈트핏이 좋은 남자" || ideal_result == "배울 점이 많은 남자" || ideal_result == "운동 잘하는 남자") {
        this.ideal_result = "슈트핏&배울점&운동 남자";
        $('section').hide();
        $('.ideal_result01').show();
      } else if (ideal_result == "캐쥬얼이 잘 어울리는 남자" || ideal_result == "유머코드가 잘 맞는 남자" || ideal_result == "요리 잘하는 남자") {
        this.ideal_result = "캐쥬얼&유머코드&요리 남자";
        $('section').hide();
        $('.ideal_result02').show();
      } else if (ideal_result == "능력이 좋은 남자") {
        this.ideal_result = "능력이 좋은 남자";
        $('section').hide();
        $('.ideal_result03').show();
      } else if (ideal_result == "직업이 좋은 남자") {
        this.ideal_result = "직업이 좋은 남자";
        $('section').hide();
        $('.ideal_result04').show();
      } else {
        $('section').hide();
  ...
  <div class="content">
    <div class="bannerwrap">
      <div class="wrap">
        ...
        <section id="lovetest">
          <div class="join-charge">
            ...
            <div style="height:600px;">
              <img class="image_size" onclick="show(2,'/new/image/ideal_worldcup/m1.jpg','슈트핏이 좋은 남자');" src="/new/image/ideal_worldcup/m1.jpg">
              <img class="image_size" onclick="show(2,'/new/image/ideal_worldcup/m2.jpg','캐쥬얼이 잘 어울리는 남자');" src="/new/image/ideal_worldcup/m2.jpg">
            </div>
            <div class="ideal_text1">
              <input value="슈트핏이 좋은 남자" class="input_text" disabled>
            </div>
            <div class="ideal_text2">
              <input value="캐쥬얼이 잘 어울리는 남자" class="input_text" disabled>
            </div>
        </section>
        ...
        <section id="lovetest">
          <div class="join-charge">
            ...
            <!-- 이상형월드컵 이미지 및 텍스트 배치 -->
            <div style="height:600px;">
              <img class="image_size" onclick="show(3,'/new/image/ideal_worldcup/m3.jpg','유머코드가 잘 맞는 남자');" src="/new/image/ideal_worldcup/m3.jpg">
              <img class="image_size" onclick="show(3,'/new/image/ideal_worldcup/m4.jpg','배울 점이 많은 남자');" src="/new/image/ideal_worldcup/m4.jpg">
            </div>
            <div class="ideal_text1">
              <input value="유머코드가 잘 맞는 남자" class="input_text" disabled>
            </div>
            <div class="ideal_text2">
              <input value="배울 점이 많은 남자" class="input_text" disabled>
            </div>
          </div>
        </section>
        ...
        <section id="lovetest">
          <div class="join-charge">
            ...
            <!-- 이상형월드컵 이미지 및 텍스트 배치 -->
            <div style="height:600px;">
              <img class="image_size" onclick="show(4,'/new/image/ideal_worldcup/m5.jpg','운동 잘하는 남자');" src="/new/image/ideal_worldcup/m5.jpg">
              <img class="image_size" onclick="show(4,'/new/image/ideal_worldcup/m6.jpg','요리 잘하는 남자');" src="/new/image/ideal_worldcup/m6.jpg">
            </div>
            <div class="ideal_text1">
              <input value="운동 잘하는 남자" class="input_text" disabled>
            </div>
            <div class="ideal_text2">
              <input value="요리 잘하는 남자" class="input_text" disabled>
            </div>
          </div>
        </section>
        ...
        <section id="lovetest">
          <div class="join-charge">
            ...
            <!-- 이상형월드컵 이미지 및 텍스트 배치 -->
            <div style="height:600px;">
              <img class="image_size" onclick="show(5,'/new/image/ideal_worldcup/m7.jpg','직업이 좋은 남자');" src="/new/image/ideal_worldcup/m7.jpg">
              <img class="image_size" onclick="show(5,'/new/image/ideal_worldcup/m8.jpg','능력이 좋은 남자');" src="/new/image/ideal_worldcup/m8.jpg">
            </div>
            <div class="ideal_text1">
              <input value="직업이 좋은 남자" class="input_text" disabled>
            </div>
            <div class="ideal_text2">
              <input value="능력이 좋은 남자" class="input_text" disabled>
            </div>
          </div>
        </section>
      ...
      font-weight: bold;" disabled>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/ideal_worldcup/p_q_bg02_m.png'); height:600px; background-repeat: no-repeat; background-position:center;">
        ...
        <!-- show(11) result=1 슈트핏&배울점&운동 남자 -->
        <section id="lovetest" class="ideal_result01">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/ideal_worldcup/p_result_bg.png'); height:600px;">
              <div>
                <img class="image_size" src="/new/image/ideal_worldcup/15.jpg">
              </div>
              ...
              <div style="display:block; margin-left:1050px; margin-top:230px;"><br><br>
                <b style="font-size: 40px;">슈트핏&배울점&운동 남자</b>
              </div>
            </div>
          </div>
        </section>
        <!-- show(12) result=2 캐쥬얼&유머코드&요리 남자 -->
        <section id="lovetest" class="ideal_result02">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/ideal_worldcup/p_result_bg.png'); height:600px;">
              <div>
                <img class="image_size" src="/new/image/ideal_worldcup/16.jpg">
              </div>
              <div style="display:block; margin-left:1050px; cursor:pointer;"><br><br>
                <img src="/new/image/ideal_worldcup/btn_re.png" alt="" onclick="javascript:location.href='/new/lovetest/ideal_worldcup.php';" />
              </div>
              <div style="display:block; margin-left:1080px; margin-top:230px;"><br><br>
                <b style="font-size: 40px;">캐쥬얼&유머코드&요리 남자</b>
              </div>
            </div>
          </div>
        </section>
        <!-- show(13) result=3 능력이 좋은 남자 -->
        <section id="lovetest" class="ideal_result03">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/ideal_worldcup/p_result_bg.png'); height:600px;">
              <div>
                <img class="image_size" src="/new/image/ideal_worldcup/17.jpg">
              </div>
              <div style="display:block; margin-left:1050px; cursor:pointer;"><br><br>
                <img src="/new/image/ideal_worldcup/btn_re.png" alt="" onclick="javascript:location.href='/new/lovetest/ideal_worldcup.php';" />
              </div>
              <div style="display:block; margin-left:1200px; margin-top:230px;"><br><br>
                <b style="font-size: 40px;">능력이 좋은 남자</b>
              </div>
            </div>
          </div>
        </section>
        <!-- show(14) result=4 직업이 좋은 남자 -->
        <section id="lovetest" class="ideal_result04">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/ideal_worldcup/p_result_bg.png'); height:600px;">
              <div>
                <img class="image_size" src="/new/image/ideal_worldcup/18.jpg">
              </div>
              <div style="display:block; margin-left:1050px; cursor:pointer;"><br><br>
                <img src="/new/image/ideal_worldcup/btn_re.png" alt="" onclick="javascript:location.href='/new/lovetest/ideal_worldcup.php';" />
              </div>
              <div style="display:block; margin-left:1200px; margin-top:230px;"><br><br>
                <b style="font-size: 40px;">직업이 좋은 남자</b>
              </div>
            </div>
          </div>
        </section>
